...
const Cards = (props) => {
    ...
    return (
        <div className="w-[150px] py-2 md:w-[273px] mx-auto px-1 md:px-4 xl:px-2 shrink-0 transform transition duration-300 hover:scale-95">
            <div className="transition duration-200 ease-in-out">
                <div className="h-[145px] md:w-full w-[130px] md:h-[182px] rounded-[15px] overflow-hidden relative">
                ...
                <div className="font-bold text-lg md:pt-2 md:px-3">
                    {isSmallScreen
                ...
                <div className="md:px-3 flex">
                    ...
                    <span className="ml-[2px] font-bold -mt-[3px]">{props.rating}</span>
                    <span className="ml-1 font-bold -mt-[3px]">
